      ...
      <div className='AdminPanel'>  
        ...
        <div className="kakakkak">
          <div className="sideBarAP">
            <div className="rowJJJJJJJ rowJJJJJJJrowJJJJJJJ">
              Dashboard
            </div>
            <div 
              onClick={()=>{
              ...
              className={isReqAdsClick ? "rowJJJ activatedrowJJJ" : "rowJJJ"} >
              Ads Applications
            </div>
            ...
            <div 
              ...
              className={AllAdsClicked ? "rowJJJ activatedrowJJJ" : "rowJJJ"} >
              Ads List
            </div>
